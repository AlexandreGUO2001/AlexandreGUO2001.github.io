...
\begin{rSection}{Research Interests}
    \begin{itemize}[leftmargin=0in]
        ...
        \item \textbf{Machine Learning}: Generative modeling, with a particular focus on (continuous/discrete) diffusion and flow-based models and with applications to vision, language, and sciences.
    \end{itemize}
\end{rSection}
...
\begin{itemize}[leftmargin=0in]
    \item Served (or currently serving) as a teaching assistant for the following courses at Georgia Tech:
\end{itemize}
...
(Numbers in parentheses indicate the number of papers reviewed.)
\begin{itemize}[leftmargin=0in]
    \item Served as a reviewer for the following conferences:
    
    ICLR 2024 (1), ICLR 2025 (3), NeurIPS 2025 (5), ICLR 2026 (6).
    
    \item Served as a reviewer for the following journals:
    
    IEEE Transactions on Information Theory (1), Transactions on Machine Learning Research (1).
\end{itemize}
\end{rSection}
